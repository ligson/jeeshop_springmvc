...
<head>
    ...
    <style type="text/css">
        ...
        img.err-product {
        <%if(StringUtils.isNotBlank(SystemManager.systemSetting.getDefaultProductImg())){%> background: url(<%=SystemManager.systemSetting.getDefaultProductImg()%>) no-repeat 50% 50%;
        <%}%>
        }
    ...
    <script>
        ...
        var baseUrl = "<%=SystemManager.systemSetting.getWww()%>";
    </script>
</head>
